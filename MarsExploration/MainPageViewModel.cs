...
namespace MarsExploration
{
    public class MainPageViewModel : BindableBase
    {
        ...
        private IFlow<SoilTelemetry> flow;
        #endregion
        ...
        {
            flow = services.GetService<IFlow<SoilTelemetry>>();
            flow.OnMeasurementReady += Flow_OnMeasurementReady;
        }

        private void Flow_OnMeasurementReady(object sender, MeasurementResultEventArgs<SoilTelemetry> e)
        {
